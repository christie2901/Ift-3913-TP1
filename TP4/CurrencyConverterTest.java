...
public class CurrencyConverterTest {
    ...
    @Test
    static void testBoiteNoireCurrencyConverter(){
    ...
    @Test
    static void testBoiteBlancheCurrencyConvert(){
        double amount = 500.0;
    ...
    public static void main(String[] args) {
        testBoiteNoireCurrencyConverter();
        System.out.println("Tests boite noire réussis");
        testBoiteBlancheCurrencyConvert();
        System.out.println("Tests boite blanche réussis");
    }
}
